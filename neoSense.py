    ...
    async with BleakClient(buzz_addr, loop=loop) as client:
        ...
        try:
            while True:
                ...
                print("+======+")
                print(motor_pattern_index)
                print("+======+")
                print(motor_pattern_value)
                print("+======+")
                print(motor_vibrate_frame)
                
                motor_pattern_index = (motor_pattern_index + 1) % 4
                motor_pattern_value = (motor_pattern_value + 10) % 255
                motor_vibrate_frame[3] = motor_pattern_value
                motor_vibrate_frame[0] = motor_pattern_value
